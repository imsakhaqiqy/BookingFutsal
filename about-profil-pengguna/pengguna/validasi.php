...
<body>
	...
	<div class="container" style="width:80%;">
		<div class="panel-group">
			<div class="panel panel-default">
				<div class="panel-heading"><h3>Konfirmasi</h3></div>
				<div class="panel-body"><p class="text-justify" style="font-family:Verdana,sans-serif">
										<ul style="font-family:Verdana,sans-serif">
											<li>Pengguna diharapkan masuk ke halaman validasi untuk melengkapi proses pembayaran.</li><br>
	...
	<footer class="container-fluid">
		...
		<h4 class="active"><a href="validasi.php">Konfirmasi</a></h4>
